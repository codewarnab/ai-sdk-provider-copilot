export { DEFAULT_CACHE_CONFIG, DEFAULT_MEMORY_CACHE_OPTIONS, createMemoryCache, createNoopCache, generateCacheKey, hashPrompt, wrapWithCache } from './chunk-3BQOD3XR.js';
export { DEFAULT_PROPAGATION_CONFIG, createPropagator } from './chunk-6YJCINQN.js';
...
async function getTraceApi() {
  if (!traceApi) {
    try {
      traceApi = await import('./esm-DW5OW26O.js');
    } catch {
    }
  }
  return traceApi;
...
async function getMetricsApi() {
  if (!metricsApi) {
    try {
      metricsApi = await import('./esm-DW5OW26O.js');
    } catch {
    }
  }
  return metricsApi;
